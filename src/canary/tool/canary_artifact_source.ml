...
type source_repo = {
  ...
  label : string option;
      (** the FREE LABEL (2026-08-15, design/enumeration/stage1_declare_spec.md Q1): [None] =
  ...
  artifacts : Canary_artifact.artifact_info list;
      (** WHAT ARTIFACTS the repo's tree builds (2026-08-16, the
          multi-repo principle — design/enumeration/stage1_declare_spec.md): the modeling
...
(* ── WORKTREE-based source checkouts (2026-08-15, design/enumeration/stage1_declare_spec.md) ──
  ...
  | None -> (
      ...
      | None ->
          (* LOCAL-ONLY repo (a fork without a remote — warning-grade per
             design/enumeration/stage1_declare_spec.md) with no [locals] entry: nothing to
