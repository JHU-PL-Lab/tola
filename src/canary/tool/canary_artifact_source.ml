...
type source_repo = {
  ...
  label : string option;
      (** the FREE LABEL (2026-08-15, design/enumeration/stage1_project_spec.md Q1): [None] =
...
(* ── WORKTREE-based source checkouts (2026-08-15, design/enumeration/stage1_project_spec.md) ──
  ...
  | None -> (
      ...
      | None ->
          (* LOCAL-ONLY repo (a fork without a remote — warning-grade per
             design/enumeration/stage1_project_spec.md) with no [locals] entry: nothing to
