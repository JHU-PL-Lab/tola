# IDs — artifacts, surfaces, agreements, scenarios (material)

*Materials collection. Not authoritative — mine for content.*

The surviving content of `design/ssot.md`, retired 2026-08-27. It held
three jobs; two of them had grown their own homes and were dropped
rather than moved:

| ssot section | fate |
| --- | --- |
| §1 Ar, §2 Sf, §3 Ag | **here** — the id dictionary, paper-side |
| §4.1 concrete good scenarios | **here** |
| §5 bad scenarios (`Bs.1..Bs.13`) | **here** — `design/tiny.md` *points at* this table rather than carrying it, so it had no other home |
