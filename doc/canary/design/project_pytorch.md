...
of `design/new_project.md` on 2026-08-05 when that doc merged into
[`../projects.md`](../projects.md); the candidate queue entry lives at
[`../projects.md`](../projects.md) §3 Tier 1 #4.
...
2. **Variant 2** — opam torch + pip torch interop: pip-install first,
   ...
   see [`../projects.md`](../projects.md) §5 level B.)
