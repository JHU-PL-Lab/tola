...
| 3. identity + order | — | material still in `store_switching.md` §6 (run order, marked for the move) and [`stage1_project_spec.md`](stage1_project_spec.md) §5 (identity) |
...
| **3. identity + order** | which assignments are the SAME scenario, and in what order they run                                                                                | `project/canary_project_run.ml` (`scenarios_of`, `scenario_dir_of`, `store_state_key`, `scenarios_in_run_order`)                                                                                         | [`store_switching.md`](store_switching.md) §6 (the pin as a lock), [`stage1_project_spec.md`](stage1_project_spec.md) §5 (ambient vs identity-bearing)                                                                                                  | `run_order.groups_by_store_state`, `matrix.registry_shape`                                                                                                                                                                                                                                                                                                                                                         |
