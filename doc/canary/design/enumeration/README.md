...
| 3. identity + order | [`stage3_identity.md`](stage3_identity.md) | **done** — identity/dedup, the general exclusive-resource principle, run order. `store_switching.md` narrowed to the opam instance |
...
| **3. identity + order** | which assignments are the SAME scenario, and in what order they run                                                                                | `project/canary_project_run.ml` (`scenarios_of`, `scenario_dir_of`, `store_state_key`, `scenarios_in_run_order`)                                                                                         | **[`stage3_identity.md`](stage3_identity.md)** — THE stage-3 doc, standalone. Background: [`store_switching.md`](store_switching.md) (the opam instance)                                                                                                  | `run_order.groups_by_store_state`, `matrix.registry_shape`, `z3.install_prefix_isolated`, `z3.env_guard_paths`, `world.one_vocabulary`                                                                                                                                                                                                                                                                                                                                                         |
